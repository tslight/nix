...
static const char *menu[] = { "wmenu-run", "-f", "JetBrainsMono Nerd Font 13", NULL };
static const char *web[]  = { "librewolf", NULL };

static const Key keys[] = {
  /* Note that Shift changes certain key codes: c -> C, 2 -> at, etc. */
  /* modifier       key                 function        argument */
  { SUPER,      XKB_KEY_space,      spawn,          {.v = menu} },
  { SUPER,      XKB_KEY_t,          spawn,          {.v = term} },
  { SUPER,      XKB_KEY_e,          spawn,          {.v = edit} },
  { SUPER,      XKB_KEY_w,          spawn,          {.v = web} },
  { SUPER,      XKB_KEY_j,          focusstack,     {.i = +1} },
  { SUPER,      XKB_KEY_k,          focusstack,     {.i = -1} },
  { ALT,        XKB_KEY_Tab,        focusstack,     {.i = +1} },
  { ALT|SHIFT,  XKB_KEY_Tab,        focusstack,     {.i = -1} },
  ...
  { SUPER,      XKB_KEY_s,          setlayout,      {0} },
  { SUPER|CTRL, XKB_KEY_f,          togglefloating, {0} },
  { SUPER,      XKB_KEY_f,          togglefullscreen, {0} },
  { SUPER,      XKB_KEY_0,          view,           {.ui = ~0} },
  { SUPER|CTRL, XKB_KEY_parenright, tag,            {.ui = ~0} },
  { SUPER,      XKB_KEY_comma,      focusmon,       {.i = WLR_DIRECTION_LEFT} },
  { SUPER,      XKB_KEY_period,     focusmon,       {.i = WLR_DIRECTION_RIGHT} },
  { SUPER|CTRL, XKB_KEY_less,       tagmon,         {.i = WLR_DIRECTION_LEFT} },
  { SUPER|CTRL, XKB_KEY_greater,    tagmon,         {.i = WLR_DIRECTION_RIGHT} },
  ...
  { SUPER|CTRL, XKB_KEY_BackSpace,  quit,           {0} },
